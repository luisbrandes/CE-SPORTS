...
public class ClassificacaoService {
    ...
    public List<ClassificacaoEquipe> calcularClassificacao(Campeonato campeonato) {
        ...
        for (Partida partida : partidas) {
            ...
            builder1.adicionarJogo(partida.getPontuacao1(), partida.getPontuacao2(), partida.isEmpate(),
                    partida.getVencedor() != null && partida.getVencedor().getNome().equals(equipe1));
            builder2.adicionarJogo(partida.getPontuacao2(), partida.getPontuacao1(), partida.isEmpate(),
                    partida.getVencedor() != null && partida.getVencedor().getNome().equals(equipe2));
