    ...
    <main className="flex flex-col items-center justify-center w-full">
      ...
      <section className="relative h-[60vh] w-full bg-[url('/img/banner1.jpg')] bg-cover bg-center flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white max-w-2xl px-4">
          ...
          <p className="text-lg opacity-90">
            Clique em Login para acessar como Aluno ou Administrador — explore
            os Campeonatos, Treinos, Projetos e Notícias.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white rounded-2xl shadow-lg p-8 md:p-10 max-w-3xl mx-4 my-10 text-center">
        ...
        <p className="text-foreground mb-3">
          ...
          <strong>CEFET-MG</strong>, criado para integrar alunos, professores e
          a comunidade acadêmica nas atividades esportivas da instituição.
        </p>
        <p className="text-foreground mb-3">
          Aqui você pode <strong>acompanhar campeonatos</strong>,{" "}
          <strong>participar de projetos esportivos</strong> e{" "}
          <strong>ficar por dentro das últimas notícias</strong> sobre o esporte
          no CEFET-MG.
        </p>
        <p className="text-foreground">
          Seja você um atleta, um organizador ou apenas um torcedor, o CE Sports
          foi feito para conectar você ao esporte!
        </p>
      </section>
